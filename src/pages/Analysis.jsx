...
function Analysis() {
  ...
  useEffect(() => {
    // Skip if analysis already exists from a persisted session
    if (analysis) return;
    if (!caseData) return;
    ...
    async function runAnalysis() {
      ...
      const agentResults = await OrchestratorAgent(result);
      ...
      const finalAnalysis = {
        ...
        complianceNotes: agentResults.compliance,
        score:           agentResults.readiness,
        timeline:        agentResults.timeline,
        assessment:      agentResults.assessment,
        notification:    agentResults.notification,
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <NotificationPanel notification={analysis.notification} />
